    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (isStarted()==false && isStopRequested()==false) {
           ...
           /* BackLeft.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
            ...
            //S-ar putea sa trb sa schimbi pe "RUN_WITHOUT_ENCODERS aici
            BackLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            FrontRight.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            FrontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            BackRight.setMode(DcMotor.RunMode.RUN_USING_ENCODER);*/
/*
            BackLeft.setTargetPosition(BackLeft.getCurrentPosition() + distance_math(100));
            FrontRight.setTargetPosition(FrontRight.getCurrentPosition() + distance_math(100));
            FrontLeft.setTargetPosition(FrontLeft.getCurrentPosition() + distance_math(100));
            BackRight.setTargetPosition(BackRight.getCurrentPosition() + distance_math(100));
          ...
          while(runtime.seconds() <= 0.95) {
            ...
            //S-ar putea sa trb sa dai un RUN_USING_ENCODER aici
           // BackLeft.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            //BackRight.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            //FrontLeft.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            //FrontRight.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
